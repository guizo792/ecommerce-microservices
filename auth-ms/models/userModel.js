...
const { Document } = require("../utils/helper");
...
// Hash passwords before save or create a new user
...
// Creating an instance method that checks password correctness for each instance of the user model
